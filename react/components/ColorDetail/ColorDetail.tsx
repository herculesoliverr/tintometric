  ...
  return (
    <section className={handles['colorDetail-container']}>
      ...
      >
        ...
        <h5 className={`t-heading-5 b mv0 ${handles['colorDetail-code']}`}>
          {selectedColor.code}
        </h5>
      </div>
      <img
        ...
        className={`${handles['colorDetail-image']} mv4`}
        src="https://pintureriasqa.vteximg.com.br/arquivos/sala.png"
        alt={selectedColor.name}
      />
      <Button>
        <Link
          onClick={() => handleModalClick(false)}
          className={handles['confirm-button']}
          to={`/${activeProductType?.slug}-${selectedColor.slug}-${selectedColor.code}/p`}
        >
          {confirmButton}
        </Link>
      </Button>
